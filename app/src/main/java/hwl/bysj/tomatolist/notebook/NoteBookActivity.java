package hwl.bysj.tomatolist.notebook;
...
public class NoteBookActivity extends Activity implements OnScrollListener,
    ...
    private void checkPermission() {
        ...
        try {
            //检测是否有写的权限
            int permission = ActivityCompat.checkSelfPermission(NoteBookActivity.this,
                    "android.permission.WRITE_EXTERNAL_STORAGE");
            if (permission != PackageManager.PERMISSION_GRANTED) {
                // 没有写的权限，去申请写的权限，会弹出对话框
                ActivityCompat.requestPermissions(NoteBookActivity.this, PERMISSIONS_STORAGE, REQUEST_EXTERNAL_STORAGE);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void RefreshNotesList() {
        ...
        simp_adapter = new SimpleAdapter(this, getData(), R.layout.item_notebook,
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        while (c.moveToNext()) {
            ...
            myIntent.setClass(NoteBookActivity.this, NoteEditActivity.class);
