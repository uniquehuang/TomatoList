package hwl.bysj.tomatolist.studyroom.write;
...
import hwl.bysj.tomatolist.databinding.ActivityWriteBinding;
...
public class WriteActivity extends AppCompatActivity {
    ...
    public void uploadFile(List<File> file,String text) {
        ...
        Observable<Object> baseEntity= RetrofitFactory.getInstence().API().downForum(sharedPreferences.getString("username",null),null,text,parts);
